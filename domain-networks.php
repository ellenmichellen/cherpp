...
<!-- Page Title
============================================= -->
<section id="slider" class="slider-parallax" style="background: linear-gradient(rgba(122, 204, 200, 0.8), rgba(74, 170, 165, 0.8)), url('<?php  bloginfo('template_url');  ?>/images/ddd.jpg?>') no-repeat; background-size: cover" data-height-lg="250" data-height-md="250" data-height-sm="200" data-height-xs="200" data-height-xxs="200">
...
<section id="content">
	...
	<div class="row clearfix common-height">
			...
			<div class="col-md-4 dark center col-padding" style="background-color: #4aaaa5;">
				<div>
					<a href="" target="_blank">
						...
						<h3>Partnerships and Community Engagement </h3>
						<span class="before-heading white">Higher education has always engaged with government, community and private sector actors. The balance of partnership and collaboration with various external actors varies across jurisdictions and over time and there can be tension over the extent that higher education systems and institutions depend on external relationships and supports.    </span>
					</a>
				</div>
			</div>
			<!-- Display and style information for each theme in the array (3 column layout) -->
			<div class="col-md-4 dark center col-padding" style="background-color: #7accc8;">
				<div>
					<a href="" target="_blank">
						<i class="i-plain i-xlarge divcenter icon-line2-briefcase"></i>
						<h3>Work Life, Careers and Professional Development</h3>
