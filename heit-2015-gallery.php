...
<!-- Page Title
============================================= -->
<section id="page-title" style="background-image: linear-gradient(rgba(135, 221, 217, 0.8), rgba(110, 183, 179, 0.8)), url('<?php  bloginfo('template_url');  ?>/images/riverliffey.jpg?>'); padding: 100px 0;" data-stellar-background-ratio="0.3">
